...
class SingleSpike(Simulation):
    ...
    def simulate_sub(self, cell, data, run_param):
        ...
        cell.simulate(rec_vmem=True,
                      ...
                      rec_isyn=True)
        # Find local maxima.
        max_idx = LFPy_util.data_extraction.find_spikes(cell.somav,
                                                        threshold=threshold)
    ...
    def process_data(self):
        ...
        if len(spikes) == 0:
            print "Could not find any spikes at threshold = {}.".format(
                run_param['threshold'])
            spikes, t_vec_spike, _ = LFPy_util.data_extraction.extract_spikes(
                data['soma_t'],
                data['soma_v'],
    ...
    def plot(self, dir_plot):
        ...
        # Plot data.
        LFPy_util.plot.soma(data['t_vec_spike'],
                            data['v_vec_spike'],
        ...
        LFPy_util.plot.i_mem_v_mem(data['soma_v'],
                                   data['stimulus_i'],
                                   data['soma_t'],
